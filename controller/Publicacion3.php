...
use Admin\Models\CategoriasModel3;
use Admin\Models\PublicacionModel3;

class Publicacion3 extends Controller
{
    ...
    {
        parent::redirect('/admin/publicacion3/all');
    }
    ...
    public function __call($method, $params)
    {
        ...
        $objCategorias = new CategoriasModel3();
        $objPublicaciones = new PublicacionModel3();
        ...
        if (in_array($method, array_column($listIdsCategorias, 'idcatg')) || $method == 'all') {
            ...
            $view->render("publicacion3/index");
        } else {
            die();
        }
    }
    ...
    public function editor($params)
    {
        ...
        $view->setVariable('listCategorias', $listCategorias);
        $view->render("publicacion3/editor");
    }
