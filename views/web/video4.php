...
<?php include_once PATH_ROOT . '/views/web/partials/header.php'; ?>
    ...
    <div class="container-fluid portada">
        <div class="container py-3 animate__animated animate__slideInLeft">
            ...
            <div class="mt-3 py-5">
                <h2 class="text-white">ULTRA TAZONES TUPPERWARE</h2>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-around">
            <div class="col-md-7">
            <iframe width="100%" height="450" src="https://www.youtube.com/embed/DicQcDDforQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
