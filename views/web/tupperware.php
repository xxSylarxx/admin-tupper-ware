            ...
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-6" style="text-align:justify;color:white;" data-aos="flip-up">
                    <p>En 1937 Earl Silas Tupper, un ingeniero químico que trabajaba
                        ...
                        empezó a experimentar con distintos derivados del plástico. Un material
                        cuyos componentes y utilidades eran pocos conocidos para la época. En vista
                        de sus escasos resultados, Tupper adquirió con sus antiguos compañeros de trabajo
                        desechos de un tipo de plástico llamado polietileno.
                    </p>
                    <p>La perseverancia en sus estudios premió a Tupper, quien transformó
                        el polietileno en un material blando, moldeable y flexible. En 1938
                        fundaría su propia compañía: Tupper Plastics Company. La producción
                        empezó con la creación del primer producto Tupper: Wonderlier Bowl
                        “el tazón maravilla”.
                    </p>
                    <p>La perseverancia en sus estudios premió a Tupper, quien transformó
                        el polietileno en un material blando, moldeable y flexible.
                        En 1938 fundaría su propia compañía: Tupper Plastics Company.
                        La producción empezó con la creación del primer producto Tupper:
                        Wonderlier Bowl “el tazón maravilla”.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 my-auto" style="text-align:justify;" data-aos="flip-up">
                    <p>Luego de una extensa búsqueda de ideas,
                        ...
                        Este diseño permitía que los alimentos almacenados
                        estuvieran frescos por más tiempo, no se derramaran
                        y ser colocados en cualquier posición. Con esta innovadora
                        idea, nacerían los famosos sellos Tupperware®</p>
                    <p>
                        La solución para la compañía llegaría de la manera más inesperada.
                        Brownie Wise, un ama de casa en la ciudad de Georgia, Atlanta, adquirió
                        varios envases Tupper, y al poco tiempo aprendió el uso del sello
                        hermético y sus beneficios.
                    </p>
                    <p>
                        Para comunicar su descubrimiento,
                        Wise compró más productos y empezó a realizar
                        reuniones con sus vecinas, para explicarles las maravillas
                        de los envases. Un día Brownie le escribió una carta a Tupper,
                        donde comentaba su sistema de demostración, al que denominó venta
                        directa, y que estaba muy interesada en poder aplicarlo en la compañía.
                    </p>
                    <p>
                        Earl Tupper aceptó esta curiosa oferta. Al poco tiempo
                        las ventas de los productos aumentarían como nunca antes,
                        lo que permitió a la compañía retirarlos de los supermercados,
                        y oficializar a la venta directa como el único método de comercialización Tupperware®.
                    </p>
                    <p>
                        En 1951 Brownie Wise sería nombrada como Vicepresidenta de la compañía,
