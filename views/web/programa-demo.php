...
<body>
    ...
    <section id="portada">
        <div class="container">
            <div class="row">
                <h1>QUIERES PROGRAMAR UNA DEMOSTRACIÓN</h1>
            </div>
        </div>
    </section>
    <br><br>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-5 d-flex justify-content-center" style="background-color:var(--color1);">
                    ...
                    <div class="p-5 " style="margin:auto auto;">
                        <h2 class="py-3" style="border-bottom: 4px solid #ffdb00;color:white;font-weight:900;">¿QUIERES PROGRAMAR UNA DEMOSTRACIÓN?</h2>

                        <br>
                        <p style="color:white;font-weight:600;">Ingresa tus datos en nuestro formulario de contacto y nuestra fuerza de ventas se pondrá en contacto contigo</p>
                        <br>
                ...
                <div class="col-lg-7 p-0">
                    <img src="<?= PATH_PUBLIC ?>/img/img-page/form-demo.jpg" class="img-fluid w-100" alt="">
                </div>
