    ...
    <section id="resumen">
        <div class="container">
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <p>El nuevo concepto de congelación.</p>
                        <p>Especialmente diseñados para congelar
                            alimentos y garantizan que al descongelarse,
                            mantengan todo su sabor y propiedades.</p>
                        <h3>INTRODUCCIÓN</h3>
                        <p>Nuestros productos garantizan la mejor 
                            conservación, frescura y sabor de los alimentos 
                            que más te gustan, en las mejores condiciones por más tiempo. 
                            Todos los productos de ésta línea están fabricados con materiales 
                            flexibles que acompañan la expansión de los alimentos al Freezarse. 
                            Permite mantener el freezer ordenado, conservando los alimentos 
                            por más tiempo.
                        </p>
                        <p>
                            Se pueden colocar unos sobre otros para ahorrar espacio en el Freezer. 
                            Poseen sellos que no permiten la contaminación de los alimentos y evitan 
                            derrames. Variedades de tamaños que se adaptan a las necesidades de almacenaje. 
                            En estos fabulosos recipientes podrás congelar gran cantidad de alimentos tales 
                            como: Pollo despresado, embutidos, carnes crudas y preparadas, pescados, etc.
                        </p>
                        <p>
                            Conservan cualquier tipo de alimentos, manteniendo por más tiempo 
                            sus características físicas de sabor y frescura.
                        </p>
                        <p>
                            Envases en material flexible, que permiten que el frío penetre y
                            el proceso de congelamiento se produzca más rápido y parejo.
                        </p>
                        <p>
                            TIPS DE USO: Al retirar los recipientes del congelador y antes de abrirlos,
                            colócalos debajo del agua para descristalizarlos evitando que se dañen.
                        </p>
                    </div>
                    <br>
                    <div class="row d-flex justify-content-around">
