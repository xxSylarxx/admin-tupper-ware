<footer class="container-fluid p-0 pt-4 ">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p style="text-align:center;color:white;word-break:break-word;">Email:informaciones@siemprejuntos.com.pe</p>
            </div>
            <div class="col-lg-4">
    ...
    <hr class="p-0 m-0">
    <p style="text-align:center;color:white;padding:10px 0px 15px 0px;margin:0;">Copyright 2022 | Tupperware | Sensfot Solutions</p>
